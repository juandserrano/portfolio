...
function ProjectCard({ image, text, link, github }) {
  return (
    <div className="w-[300px] h-[500px] md:w-[600px] mx-5 md:h-[650px] p-8 frosty shadow-lg rounded-3xl flex flex-col items-center justify-around flex-shrink-0">
      <div className="relative w-11/12 h-2/6 md:h-4/6 border-2 border-yellow-400">
        <img src={image} className='absolute h-full w-full'/>
      </div>
